...
public class ClientTCP
{
	...
	private static int messageSize;         //size of the text message NOT the 
											//total message sent to server!!!
	private static byte requestID = 1;      //Request id for the client 
											//(allowed to be hardcoded as of 
											//17 Sep 2015)
	...
	*/
	public static void main(String[] args)
	{
		...
		{
			System.out.println("\n\nString doesn't contain parsable integer\n");
			e.printStackTrace();
		}
		...
		try {
			...
			//servers to process the end of our packet correctly
			stream.write(data);
			stream.flush();
			...
			long timeElapsed = (System.nanoTime() - startTime) / 1000; // ns->us

			System.out.println("Round Trip Time: " + timeElapsed 
				+ " microseconds");
